# next is http://www.pythonchallenge.com/pc/def/linkedlist.php
...
for pos, letter in enumerate(text):
    if str.isupper(letter) and str.isupper(text[pos + 1]) and str.isupper(text[pos + 2]) and str.islower(
            text[pos + 3]) and \
            str.isupper(text[pos + 4]) and str.isupper(text[pos + 5]) and str.isupper(text[pos + 6]) and not str.isupper(text[pos + 7])and not str.isupper(text[pos  -1]):
        print(text[pos + 3])
